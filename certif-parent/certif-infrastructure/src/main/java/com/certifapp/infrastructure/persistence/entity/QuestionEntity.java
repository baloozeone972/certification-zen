...
public class QuestionEntity {
    ...
    public void setLegacyId(String l)                 { this.legacyId = l; }
    public String getCertificationId()                { return certificationId; }
    public void setCertificationId(String c)          { this.certificationId = c; }
    public UUID getThemeId()                          { return themeId; }
    public void setThemeId(UUID t)                    { this.themeId = t; }
    ...
    public String getExplanationOriginal()            { return explanationOriginal; }
    public void setExplanationOriginal(String e)      { this.explanationOriginal = e; }
    public String getExplanationEnriched()            { return explanationEnriched; }
    public void setExplanationEnriched(String e)      { this.explanationEnriched = e; }
    public String getExplanationStatus()              { return explanationStatus; }
    public void setExplanationStatus(String s)        { this.explanationStatus = s; }
    public int getExplanationVersion()                { return explanationVersion; }
    public void setExplanationVersion(int v)          { this.explanationVersion = v; }
    public String getOfficialDocUrl()                 { return officialDocUrl; }
    public void setOfficialDocUrl(String u)           { this.officialDocUrl = u; }
    ...
    public void setAiConfidenceScore(Double s)        { this.aiConfidenceScore = s; }
    public UUID getLastReviewedBy()                   { return lastReviewedBy; }
    public void setLastReviewedBy(UUID u)             { this.lastReviewedBy = u; }
    ...
    public void setOptions(List<QuestionOptionEntity> o) { this.options = o; }
}
