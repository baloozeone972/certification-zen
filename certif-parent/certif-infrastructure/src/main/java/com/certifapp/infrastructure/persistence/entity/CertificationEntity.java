...
public class CertificationEntity {
    ...
    public void setExamQuestionCount(int n) {
        this.examQuestionCount = n;
    }

    public int getExamDurationMin() {
        return examDurationMin;
    }

    public void setExamDurationMin(int n) {
        this.examDurationMin = n;
    }
    ...
    public void setPassingScore(int n) {
        this.passingScore = n;
    }
    ...
    public void setExamType(String t) {
        this.examType = t;
    }
    ...
    public List<CertificationThemeEntity> getThemes() {
        return themes;
    }

    public void setThemes(List<CertificationThemeEntity> t) {
        this.themes = t;
    }
}
