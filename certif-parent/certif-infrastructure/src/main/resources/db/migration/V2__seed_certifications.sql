...
VALUES
    ('ocp21',        '1Z0-830',   'Oracle Certified Professional Java SE 21 (1Z0-830)',
...
-- OCP Java 21 (1Z0-830)
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'ocp21', 'virtual_threads',      'Virtual Threads',                     60, 0),
...
-- OCP Java 17 (1Z0-829)
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'ocp17', 'jpms',               'Java Modules (JPMS)',                   50, 0),
...
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'spring6', 'spring_core',    'Spring Core et IoC',          70, 0),
...
-- Spring Boot 3
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'springboot3', 'auto_config',  'Spring Boot Auto-configuration', 60, 0),
...
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'aws_ccp', 'cloud_concepts',  'Cloud Concepts',      60,  0),
...
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'aws_saa', 'compute',       'Compute (EC2, Lambda, ECS)',          80, 0),
...
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'aws_dev', 'lambda',       'Lambda & Serverless',   80, 0),
...
-- Docker DCA
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'docker', 'basics',    'Docker Basics',          60, 0),
...
-- CKA
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'cka', 'cluster_arch',   'Cluster Architecture',       40, 0),
...
-- CKAD
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'ckad', 'app_design',    'Application Design',        40, 0),
...
-- CKS
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'cks', 'cluster_hardening', 'Cluster Hardening',    30, 0),
...
-- Android Kotlin
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'android', 'compose',      'Jetpack Compose',        70, 0),
...
-- Terraform
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'terraform', 'basics',        'Terraform Basics',         50, 0),
...
-- GCP Digital Leader
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'gcp_dl', 'digital_transform', 'Digital Transformation', 50, 0),
...
-- Java 21 Général
INSERT INTO certification_themes (id, certification_id, code, label, question_count, display_order) VALUES
    (uuid_generate_v4(), 'java21', 'fondamentaux',   'Fondamentaux du Langage',              50, 0),
