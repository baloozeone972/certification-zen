...
public class QuestionTest {
    ...
    public void setUp() {
        ...
        ExplanationStatus explanationStatus = ExplanationStatus.VALIDATED;
    ...
    public void bestExplanation_enrichedValidated() {
        ...
        ExplanationStatus status = ExplanationStatus.VALIDATED;
    ...
    public void correctOption_edgeNoCorrect() {
        when(options.stream().filter(QuestionOption::isCorrect)).thenReturn(Arrays.stream(List.of()));
        Optional<QuestionOption> result = question.correctOption();
