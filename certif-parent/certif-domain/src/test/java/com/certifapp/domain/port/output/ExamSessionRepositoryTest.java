...
public class ExamSessionRepositoryTest {
    ...
    @InjectMocks
    private ExamSessionRepositoryImpl examSessionRepositoryImpl; // Assuming there's an implementation
    ...
    public void findById_nominalCase_returnsExamSession() {
        ...
        ExamSession session = new ExamSession(id, UUID.randomUUID(), "cert1", ExamMode.PREMIUM, LocalDate.now());
    ...
    public void countTodayByUserAndCertification_nominalCase_returnsCount() {
        ...
        ExamMode mode = ExamMode.PREMIUM;
    ...
    public void save_nominalCase_returnsSavedSession() {
        ExamSession session = new ExamSession(UUID.randomUUID(), UUID.randomUUID(), "cert1", ExamMode.PREMIUM, LocalDate.now());
